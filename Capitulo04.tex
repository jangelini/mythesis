...
En este cap\'itulo se describen los resultados del experimento. Se muestran los datos recabados con descripciones de las observaciones hechas sobre los datos. Se describen algunas de las interpretaciones de los datos. Por \'ultimo, se muestran los resultados de las pruebas utilizando aprendizaje de m\'aquina.
...
Para este trabajo, se utilizaron los datos de 5 participantes. El total de sesiones usados fue 15. Los datos usados en las siguientes secciones son los correspondientes a los participantes P1, P6, P7, P8 y P9. El anexo ~\ref{aped:data} contiene el conteo de muestras por participante y los datos recolectados por cada uno.
%inserta tabla aqui%
        \begin{table}[h!]
                \footnotesize
                \centering
...
[aqui poner las 3 gr\'aficas de GSR]
...
Se cont\'o con un total de 212 muestras de ansiedad y un 310 de muestras de no ansiedad. (La tabla ~\ref{tab:anxietycounts} incluye a detalle los conteos de muestras)
\begin{table}[h!]
        \footnotesize
        \centering
